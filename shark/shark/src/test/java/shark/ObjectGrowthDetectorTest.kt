...
class ObjectGrowthDetectorTest {
  ...
  private fun HeapDumpObjectGrowthDetector.detectHeapGrowth(heapDumps: List<Pair<CloseableHeapGraph, Int>>): HeapTraversalWithDiff {
  ...
  private fun newSimpleDetector(): HeapDumpObjectGrowthDetector {
