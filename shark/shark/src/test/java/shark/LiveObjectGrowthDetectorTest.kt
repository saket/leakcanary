...
class LiveObjectGrowthDetectorTest {
  ...
  private fun HeapDumpObjectGrowthDetector.live(
    scenarioLoopsPerDump: Int = 1,
    maxHeapDumps: Int = 5
  ): HeapDumpingObjectGrowthDetector {
    return HeapDumpingObjectGrowthDetector(maxHeapDumps, ::dumpHeapGraph, scenarioLoopsPerDump, HeapDumpSequenceObjectGrowthDetector(this))
  }

  private fun simpleDetector(): HeapDumpObjectGrowthDetector {
    ...
    return HeapDumpObjectGrowthDetector(gcRootProvider, referenceReaderFactory)
  }

  private fun openJdkDetector(): HeapDumpObjectGrowthDetector {
    val referenceMatchers = JdkReferenceMatchers.defaults + HeapTraversal.ignoredReferences
